/*
 * sorce used to change the title  text
 * //http://www.clearlyinnovative.com/blog/post/1484840648/titanium-appcelerator-quickie-change-text-style-in-window-title
 *
 * The Window Class makes sure all windows look identical, have the same
 * properties and functons.
 * It also checks if the device is running ios7 and will display the windows
 * sightly differently.
 */
function windowClass(title) {
	...
	// execute 'changeOrientation' when window first opens and than on every
	// orientation change
