// The html used to display an error message to the user when the internet isn't
// available or some other error occurred.
...
// file paths for saving and accessing the xml file from the web. (useful for
// off-line access)
